...
<body id="page-top" class="index">
    ...
    <?php
        $nombre = array('name' => 'nombre',
                                        ...
                                        'placeholder' => 'Nombre',
                                        'id' => 'nombre',
                                        'required data-validation-required-message' => 'Por favor, introduzca su nombre.');
        ...
        $mensaje   = array('name' => 'mensaje',
                                        ...
                                        'placeholder' => 'Mensaje',
                                        'id' => 'mensaje',
                                        'required data-validation-required-message' => 'Por favor, introduzca un mensaje.');
    ?>    
                    ...
                    <form name="sentMessage" id="contactForm" novalidate>
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12">
                                <!--<?= form_submit('','Entrar') ?> -->
                                <button type="submit" class="btn btn-success btn-lg">Mandar</button>
